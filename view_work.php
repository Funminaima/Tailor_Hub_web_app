		...
		<div class="row">
				...
				<div class="col-md-4 my-2">
					...
					<div class="card-body">
						...
						<a href="addcart.php?t_id=<?php echo $tail_id; ?>&nameb=<?php echo $name; ?>&pro_name=<?php echo $p_name; ?>&Upload=<?php echo $image; ?>&upload_id=<?php echo $upload_id; ?>&&amt=<?php echo $amt; ?>" class="btn btn-dark">order now</a>
					</div>
					</div>
				</div>
				...
				?>
					<!-- <form action="" method="post" enctype="multipart/form-data">
						...
						<textarea name="text" class="form-control" cols="40" rows="5" placeholder="Say something about the image"></textarea>
